...
model.fc =  nn.Sequential(
               ...
               forest.Forest(in_features=512, num_trees=8, tree_depth=7, num_classes=args.num_classes))
...
scheduler = StepLR(base_lr=args.lr, step_size=len(train_loader)*20)
