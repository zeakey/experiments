...
class MSNet(nn.Module):
    ...
    def __init__(self, block, num_classes=1000, zero_init_residual=False):
        ...
        layer0 = MSModule(block_high, block_low, in_channels=64, high_channels=64, low_channels=64)
        ...
        block_merge = Downsample(256, 256, stride=2)
        ...
        block_merge = Downsample(512, 512, stride=2)
        ...
        block_merge = Downsample(1024, 1024, stride=1)
