...
SRC = '~/dataset/MSRA-B/image/';       %Path of input images
BDCON = '~/kai/MSRA-B-rbd-data/bdcon';   %Path for saving bdCon feature image
RES = '~/kai/MSRA-B-rbd-data/sal-results';       %Path for saving saliency maps
